...
# Uses the reduce function from the inbuilt module functools. Also defines a method spread for javascript like spreading of lists [...array] SUPER USEFUL THIS TRANSLATES DIRECTLY TO JS
